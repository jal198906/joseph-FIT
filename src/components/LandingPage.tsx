...
export default function LandingPage({ onStart, onGoogleLogin, currentTime }: LandingPageProps) {
  const features = [
    {
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <button
              ...
              className="px-8 py-4 bg-white text-slate-700 rounded-2xl font-bold text-lg border border-slate-200 hover:bg-slate-50 transition-all flex items-center gap-3 shadow-sm"
            >
