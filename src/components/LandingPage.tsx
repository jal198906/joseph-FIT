...
export default function LandingPage({ onStart, onGoogleLogin, currentTime, isLoggingIn, loginError }: LandingPageProps) {
  const features = [
    {
          ...
          >
            ...
            <div className="flex flex-col items-center gap-2">
              <button
                ...
                className="px-8 py-4 bg-white text-slate-700 rounded-2xl font-bold text-lg border border-slate-200 hover:bg-slate-50 transition-all flex items-center gap-3 shadow-sm w-full sm:w-auto disabled:opacity-50"
              >
                {isLoggingIn ? (
                ...
                {isLoggingIn ? 'Iniciando...' : 'Iniciar sesión con Google'}
              </button>
              <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">
                Para que guarde el progreso
              </p>
              {loginError && (
            ...
            <a
              href="#features"
              className="px-8 py-4 text-slate-500 rounded-2xl font-bold text-lg hover:text-slate-900 transition-all"
            >
              Saber más
            </a>
          </motion.div>
